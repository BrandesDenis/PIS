...
finance_objects_matching = {
    'Ипотека': 'Ипотека',
    'Долги и кредиты': 'Ипотека',
    'Долг бате по ипотеке': 'Долг бате по ипотеке',
    'Отдых': 'Отдых',
    'Кино': 'Отдых',
    'Рубашки,свитера,футболки': 'Одежда и внешний вид',
    'Обувь и аксессуары': 'Одежда и внешний вид',
    'Спортпит': 'Спорт',
    'Тренажерный зал': 'Спорт',
    'Штаны': 'Одежда и внешний вид',
    'Стрижка и прочее': 'Одежда и внешний вид',
    'Куртки и подобное': 'Одежда и внешний вид',
    'Прочая одежда': 'Одежда и внешний вид',
    'Брюки, штаны, шорты': 'Одежда и внешний вид',
    'Танго': 'Спорт',
    'Спорт и вн.вид': 'Спорт',
    'Штаны, шорты': 'Одежда и внешний вид',
    'Пиджак': 'Одежда и внешний вид',
    'Гантели': 'Спорт',
    'Парфюм': 'Одежда и внешний вид',
    'Спортивная сумка': 'Спорт',
    'Аксессуары': 'Одежда и внешний вид',
    'Гигиенические принадлежности': 'Одежда и внешний вид',
    'Турник': 'Спорт',
    'Груша': 'Спорт',
    'Пр. расходы на п14': 'Одежда и внешний вид',
    'Химчистка одежды': 'Одежда и внешний вид',
    'Перчатки для груши': 'Спорт',
    'Витамины,лекарства...': 'Здоровье',
    'Селфи палка': 'Разовые расходы',
    'Средства личной гигиены': 'Одежда и внешний вид',
    'Прочие(спорт)': 'Спорт',
    'Питание': 'Питание',
    ...
    'Бытовые расходы': 'Бытовые расходы',
    ...
    'Здоровье': 'Здоровье',
    'Расходы на операцию ПКС': 'Здоровье',
    'Лечение': 'Здоровье',
    'Лекарства': 'Здоровье',
    'Очки для компьютера': 'Здоровье',
    'Лечение зубов': 'Здоровье',
    'Фиксатор осанки': 'Здоровье',
    ...
    'Кэшбек': 'Кэшбек',
    'Рост вклада': 'Проценты по вкладу',

    'Прочие доходы': 'Прочий доход',
    ...
    'Образовательные расходы': 'Образовательные расходы',
}
